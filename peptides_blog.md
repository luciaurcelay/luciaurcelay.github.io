...
This blog post was inspired by a conversation I had with my lab colleagues during last Christmas' dinner. One of them casually mentioned something about a **"Chinese peptide rave"** happening in San Francisco in December 2025 (https://luma.com/chinesepeptides), to which I responded: what is even that about?

The event went viral. Even **The New York Times** covered it (https://www.nytimes.com/2026/01/03/business/chinese-peptides-silicon-valley.html). Pictures show a mix-your-own peptides workshop, a DJ spinning techno under projected chemical structures, and a dress code calling for "crazy futuristic cyberpunk attire."

But the aesthetic is just the surface. The peptide craze is real—and measurable. The NYT reports that, according to U.S. customs data, imports of hormone and peptide compounds from China roughly **doubled to $328 million** in the first three quarters of 2025, up from $164 million in the same period of 2024. This includes demand for **GLP-1 analogues**, **melanotan II**, and various other peptides supplied through compounding pharmacies and **gray-market channels**.

**Therapeutic peptides** are a distinct class of pharmaceutical agents composed of short chains of amino acids—typically 2 to ~50 residues, corresponding roughly to molecular weights of ~500–5,000 Da (Nature Reviews, 2022). Since the therapeutic use of **insulin** began in 1921, peptide drugs have steadily expanded in scope. As of 2024–2025, there are **over 80 approved peptide drugs** globally, spanning endocrinology, oncology, infectious disease, and metabolic disorders.

Following the classification proposed by **Dr. Eric Topol** in his Substack piece on the peptide craze, I'll organize this post into two categories:
...
Then, I'll shift gears and review the state of the art in **machine learning for peptide design**, because if people are going to peptide-max, at least let's understand how the molecules could be invented in the near future.
...
Critically, **GLP-1 receptor agonists** only stimulate insulin release when glucose levels are elevated, reducing the risk of **hypoglycemia** compared to older diabetes drugs.

Originally, these drugs were prescribed to improve glycemic control in type 2 diabetes. But during clinical trials, patients consistently lost significant weight. That observation—initially a "side effect" became the main event.

**Semaglutide** (approved as **Ozempic** for diabetes and later as **Wegovy** for obesity) and dual agonists like **tirzepatide** (which also targets **GIP receptors**) demonstrated substantial weight loss in randomized controlled trials—often **10–20% of body weight**, approaching the efficacy of surgery in some cases. Large cardiovascular outcome trials also showed reductions in **major adverse cardiovascular events** in high-risk populations (Nature Reviews Drug Discovery, 2025).

And that's when the cultural shift began.

What started as **metabolic therapy** became **aesthetic therapy**. Which brings us to the broader ecosystem.
...
They can be purchased directly from overseas manufacturers, often labeled **"for research use only."** The label functions more as a legal shield than a biological one. Users self-inject, typically using insulin syringes.

**Microdosing culture** has now merged with **peptide culture**.
...
References
	1.	Wang, L. et al. Therapeutic peptides: current applications and future directions. Nature Reviews (2022). https://www.nature.com/articles/s41392-022-00904-4
	2.	Nature Reviews Drug Discovery (2025). GLP-1 receptor agonists and cardiometabolic outcomes. https://www.nature.com/articles/s41573-025-01183-8
	3.	The New York Times (2026). Chinese Peptides and Silicon Valley Biohacking Culture. https://www.nytimes.com/2026/01/03/business/chinese-peptides-silicon-valley.html
	...
	7.	SurfFlow. arXiv:2601.04506 (2025). https://arxiv.org/abs/2601.04506
	8.	PepFlow. arXiv:2406.00735 (2024). https://arxiv.org/abs/2406.00735
